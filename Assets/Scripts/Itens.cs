...
public static class Itens{
	...
	public static void CarregarItens(){
		...
		item [4] = new Item ("Cajado de Bataha", "", EnumTipoItem.Arma, 100, 1, 0, 15, Resources.Load<Sprite>("ItemIcons/Staff"), Resources.Load<Mesh>("ItemModels/cajado_de_batalha"), 0, 4);
		...
		item [7] = new Item ("Cajado da Areia", "", EnumTipoItem.Arma, 10, 1, 0, 10, Resources.Load<Sprite>("ItemIcons/Staff"), Resources.Load<Mesh>("ItemModels/cajado_da_areia"), 0, 7);
		item [8] = new Item ("Trapos de Maego Eremita", "", EnumTipoItem.Armadura, 0, 1, 10, 0, Resources.Load<Sprite>("ItemIcons/Armadura"), Resources.Load<Mesh>("ItemModels/trapos_de_mago_eremita"), 0, 8);
	}
