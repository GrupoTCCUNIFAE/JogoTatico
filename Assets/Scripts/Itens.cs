...
public static class Itens{
	...
	public static void CarregarItens(){
		...
		item [1] = new Item ("Sobretudo de Mago", "", EnumTipoItem.Armadura, 10, 1, 10, 0, Resources.Load<Sprite>("ItemIcons/sobretudo_de_mago"), Resources.Load<Mesh>("ItemModels/sobretudo_de_mago"), 0, 1);
		item [2] = new Item ("Manto de Mago das Sombras", "", EnumTipoItem.Armadura, 50, 1, 15, 0, Resources.Load<Sprite>("ItemIcons/manto_de_mago_das_sombras"), Resources.Load<Mesh>("ItemModels/manto_de_mago_das_sombras"), 0, 2);
		...
		item [5] = new Item ("Armadura de Mago de Batalha", "", EnumTipoItem.Armadura, 10, 10, 20, 0, Resources.Load<Sprite>("ItemIcons/armadura_de_mago_de_batalha"), Resources.Load<Mesh>("ItemModels/armadura_de_mago_de_batalha"), 0, 5);
		...
		item [8] = new Item ("Trapos de Mago Eremita", "", EnumTipoItem.Armadura, 0, 1, 10, 0, Resources.Load<Sprite>("ItemIcons/trapos_de_mago_eremita"), Resources.Load<Mesh>("ItemModels/trapos_de_mago_eremita"), 0, 8);
	}
